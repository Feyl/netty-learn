...
import com.feyl.netty.advance.chat_room.message.*;
                        ...
                        public void channelActive(ChannelHandlerContext ctx) throws Exception {
                            ...
                            new Thread(() -> {
                                ...
                                while (true) {
                                    ...
                                    System.out.println("gmember [group name]");
                                    System.out.println("gjoin [group name]");
                                    System.out.println("gexit [group name]");
                                    ...
                                    switch (s[0]) {
                                        ...
                                        case "gjoin":
                                            ...
                                            break;
                                        case "gexit":
                                            ctx.writeAndFlush(new GroupExitRequestMessage(username, s[1]));
                                            break;
                                        case "quit":
                                            ctx.channel().close();
                                            return;
